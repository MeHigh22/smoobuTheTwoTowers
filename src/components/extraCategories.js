  ...
  softs: {
    ...
    items: [
      ...
      },
      {
        ...
        description: 'Une boisson pétillante aux saveurs de citron et framboise.',
        price: 3,
...
// Helper function to calculate total for selected extras
